 ...
 * @author whli
 * @version 1.0.0
 * @since 2019/10/13 9:46
 */
public class SnowflakeUtils {

    private static SnowflakeUtils snowflake;

    // ==============================Fields===========================================
    /** 开始时间截 (2019-10-13) */
    private final long twepoch = 1570931275282L;
    ...
    public  static SnowflakeUtils getInstance(long workerId, long datacenterId){
        if (snowflake == null){
            synchronized(SnowflakeUtils.class){
                if (snowflake == null){
                    snowflake = new SnowflakeUtils(workerId,datacenterId);
                }
            }
        }
        return snowflake;
